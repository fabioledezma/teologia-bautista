...
export default function TeologiaHistoricaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-5 py-16 md:py-24">
        <div className="text-center mb-12">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-text mt-4">
            Teología <span className="text-gold">Histórica</span>
          </h1>
          <div className="section-title-line mt-3 mb-3" />
          <p className="text-text text-sm max-w-2xl mx-auto">
            Cómo se desarrollaron las doctrinas cristianas a través de los siglos: desde la iglesia
            primitiva hasta la Reforma, con perspectiva bautista reformada.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-5">
          {teologiaHistorica.map((mod, i) => (
            <Link
              key={mod.slug}
              href={`/historia/teologia-historica/${mod.slug}`}
              ...
              <div className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-text text-sm mt-1">{mod.subtitle}</p>
        ...
        <div className="text-center mt-10">
          <Link
            href="/historia/teologia-historica/prolegomenos"
