...
const doctrinas: Doctrina[] = [
  ...
  },
  {
    ...
    simple:
      "La Trinidad es la doctrina de que el único Dios verdadero existe eternamente como tres personas: el Padre, el Hijo y el Espíritu Santo. El Padre no es el Hijo, el Hijo no es el Padre, y el Espíritu Santo no es ni el Padre ni el Hijo. Sin embargo, estos tres no son tres dioses, sino un solo Dios. Cada persona es completamento Dios, poseyendo toda la plenitud de la deidad. No compartimos la naturaleza divina, sino que cada persona es esa naturaleza divina en su totalidad.",
    fondo:
